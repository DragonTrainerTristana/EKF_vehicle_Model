...
for cnt = 1 : 100
    ...
    final_predict = array2table(predictedData(:,1:10),"VariableNames",["id1_x","id1_y","id2_x","id2_y","id3_x","id3_y","id4_x","id4_y","id5_x","id5_y"]);
    final_real = array2table(realData(:,1:10),"VariableNames",["id1_x","id1_y","id2_x","id2_y","id3_x","id3_y","id4_x","id4_y","id5_x","id5_y"]);

    fp_p = "PredictedData" + cnt + ".csv";
    fp_r = "realData" + cnt + ".csv";

    writetable(final_predict,fp_p)
    writetable(final_real,fp_r)
