...
final_predict = array2table(predictedData(:,1:16),"VariableNames",["id1_x","id1_y","id2_x","id2_y","id3_x","id3_y","id4_x","id4_y","id5_x","id5_y","id6_x","id6_y","id7_x","id7_y","id8_x","id8_y","id9_x","id9_y"]);
final_real = array2table(realData(:,1:16),"VariableNames",["id1_x","id1_y","id2_x","id2_y","id3_x","id3_y","id4_x","id4_y","id5_x","id5_y","id6_x","id6_y","id7_x","id7_y","id8_x","id8_y","id9_x","id9_y"]);


writetable(final_predict,'predictedData,')
writetable(final_real,'realData11.csv')
